#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Gas Grill Scraper
Scrapes all gas grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/7521/cooking/grills/gas"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Gas Grill Scraper")
    print("=" * 60)
