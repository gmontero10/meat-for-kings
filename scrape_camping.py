#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Camping Grill Scraper
Scrapes all camping grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/23999/beyond-the-backyard/grills/camping"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Camping Grill Scraper")
    print("=" * 60)
