#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Pizza Oven Scraper
Scrapes all pizza oven products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/21225/cooking/pizza-ovens"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Pizza Oven Scraper")
    print("=" * 60)
