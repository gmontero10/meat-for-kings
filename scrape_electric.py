#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Electric Grill Scraper
Scrapes all electric grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/11180/cooking/grills/electric"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Electric Grill Scraper")
    print("=" * 60)
