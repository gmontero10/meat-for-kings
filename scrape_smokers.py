#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Smoker Scraper
Scrapes all smoker products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/7122/cooking/smokers"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Smoker Scraper")
    print("=" * 60)
