#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Kamado Grill Scraper
Scrapes all kamado grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/11447/cooking/grills/kamado"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Kamado Grill Scraper")
    print("=" * 60)
