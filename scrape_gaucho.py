#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Gaucho Grill Scraper
Scrapes all Argentinian/gaucho/Santa Maria grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/24933/cooking/grills/argentinian-gaucho-santa-maria"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Gaucho Grill Scraper")
    print("=" * 60)
