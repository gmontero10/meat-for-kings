#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Charcoal Grill Scraper
Scrapes all charcoal grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/9994/cooking/grills/charcoal"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Charcoal Grill Scraper")
    print("=" * 60)
