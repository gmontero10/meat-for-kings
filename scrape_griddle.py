#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Flat Top Griddle Scraper
Scrapes all flat top griddle products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/16462/cooking/grills/gas/flat-top-griddles"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Flat Top Griddle Scraper")
    print("=" * 60)
