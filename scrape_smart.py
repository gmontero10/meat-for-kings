#!/usr/bin/env python3
"""
Meat for Kings — BBQGuys Smart Grill Scraper
Scrapes all smart grill products from BBQGuys.com into an SQLite database.
...
BASE_URL = "https://www.bbqguys.com/d/26195/cooking/grills/smart-grills"
DB_PATH = "catalog.db"
MAX_RETRIES = 2
...
def main():
    print("Meat for Kings — BBQGuys Smart Grill Scraper")
    print("=" * 60)
